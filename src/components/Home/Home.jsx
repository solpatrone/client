...
export default function Home() {
  ...
  function displaySelectedRestaurantes() {
    ...
    const currentRestos = restaurantesByPrice.slice(indexOfFirstPost, indexOfLastPost);
  ...
  }, [allRestaurants, filteredByNeighborhood, filteredByPrice, filteredByFoodTypes, currentPage])
